...
@Component({
  ...
  template: `
    <div class="flex gap-2 mb-3 items-center">
      ...
      <button (click)="navigatePrivate.emit()" class="bg-blue-600 text-white px-3 py-1 rounded">Ir para privado</button>
      <button (click)="navigateGroup.emit()" class="bg-indigo-600 text-white px-3 py-1 rounded">Ir para coletivo</button>
